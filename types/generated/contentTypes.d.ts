...
export interface ApiAboutGlobalAboutGlobal extends Struct.SingleTypeSchema {
  collectionName: 'about_globals';
  info: {
    displayName: 'AboutGlobal';
    pluralName: 'about-globals';
    singularName: 'about-global';
  };
  options: {
...
export interface ApiCarouselCollectionCarouselCollection
  extends Struct.CollectionTypeSchema {
...
export interface ApiCarouselGlobalCarouselGlobal
  extends Struct.SingleTypeSchema {
  collectionName: 'carousel_globals';
  info: {
    displayName: 'CarouselGlobal';
    pluralName: 'carousel-globals';
    singularName: 'carousel-global';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::carousel-global.carousel-global'
    >;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiHomePageHomePage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    carousel_collections: Schema.Attribute.Relation<
      ...
      'api::carousel-collection.carousel-collection'
    >;
    ContentHomePage: Schema.Attribute.DynamicZone<['about.about', 'faq.faq']> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    >;
    NavBar: Schema.Attribute.DynamicZone<['navbar.nav-item']> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiImageFileImageFile extends Struct.CollectionTypeSchema {
  collectionName: 'images_files';
  info: {
    description: '';
    displayName: 'Images';
    pluralName: 'images-files';
    singularName: 'image-file';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiMediaFileMediaFile extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Images: Schema.Attribute.Component<'media.images', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    Publications: Schema.Attribute.Component<'media.publications', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Videos: Schema.Attribute.Component<'media.videos', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiNavbarGlobalNavbarGlobal extends Struct.SingleTypeSchema {
  ...
  info: {
    description: '';
    displayName: 'NavbarGlobal';
    pluralName: 'navbar-globals';
    singularName: 'navbar-global';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::navbar-global.navbar-global'
    >;
    Navbar: Schema.Attribute.Component<'navbar.nav-item', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiNewsCollectionNewsCollection
  extends Struct.CollectionTypeSchema {
...
export interface ApiNewsGlobalNewsGlobal extends Struct.SingleTypeSchema {
  collectionName: 'news_globals';
  info: {
    displayName: 'NewsGlobal';
    pluralName: 'news-globals';
    singularName: 'news-global';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiQuickLinksCollectionQuickLinksCollection
  extends Struct.CollectionTypeSchema {
  collectionName: 'quick_links_collections';
  info: {
    displayName: 'QuickLinksCollection';
    pluralName: 'quick-links-collections';
    singularName: 'quick-links-collection';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiQuickLinksGlobalQuickLinksGlobal
  extends Struct.SingleTypeSchema {
  collectionName: 'quick_links_globals';
  info: {
    displayName: 'QuickLinksGlobal';
    pluralName: 'quick-links-globals';
    singularName: 'quick-links-global';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::quick-links-global.quick-links-global'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::about-global.about-global': ApiAboutGlobalAboutGlobal;
